...
urlpatterns = [
    ...
    url(r'^restaurant/list$', views.list_restaurant, name='list_restaurant'),
    url(r'restaurant/detail/(?P<place_id>[0-9]+)$', views.view_detail_restaurant, name='view_detail_restaurant'),
    url(r'restaurant/update/(?P<place_id>[0-9]+)$', views.update_restaurant, name='update_restaurant'),
    url(r'restaurant/delete/(?P<place_id>[0-9]+)$', views.delete_restaurant, name='delete_restaurant'),
    url(r'^waiter/list$', views.list_waiter, name='list_waiter'),
    url(r'waiter/detail/(?P<waiter_id>[0-9]+)$', views.view_detail_waiter, name='view_detail_waiter'),
    url(r'waiter/update/(?P<waiter_id>[0-9]+)$', views.update_waiter, name='update_waiter'),
    url(r'waiter/delete/(?P<waiter_id>[0-9]+)$', views.delete_waiter, name='delete_waiter'),

    url(r'^class/place/list$',class_base_views.PlaceListView.as_view(), name='class_list_places'),
    url(r'^class/list/view$',class_base_views.PlaceListView.as_view(), name='class_list_view_places'),
    url(r'^class/place/detail/(?P<pk>[0-9]+)$',class_base_views.PlaceDetailView.as_view(), name='class_view_detail_place'),
    url(r'^class/place/add$',class_base_views.PlaceCreatView.as_view(), name='class_add_place'),
    ...
    url(r'^class/restaurant/list$',class_base_views.RestaurantListView.as_view(), name='class_list_restaurant'),
    url(r'^class/restaurant/detail/(?P<pk>[0-9]+)$',class_base_views.RestaurantDetailView.as_view(), name='class_view_detail_restaurant'),
    url(r'^class/restaurant/add$',class_base_views.RestaurantCreatView.as_view(), name='class_add_restaurant'),
    ...
    url(r'^class/waiter/list$',class_base_views.WaiterListView.as_view(), name='class_list_waiter'),
    url(r'^class/waiter/detail/(?P<pk>[0-9]+)$',class_base_views.WaiterDetailView.as_view(), name='class_view_detail_waiter'),
    url(r'^class/waiter/add$',class_base_views.WaiterCreatView.as_view(), name='class_add_waiter'),
    ...
    url(r'^cafef_articles$',views.list_cafef_articles, name='list_cafef_articles'),
    url(r'^moneyclub$', views.list_money , name='moneyclub'),
